...
from imgflip_sdk.utility import register

# Load features
from imgflip_sdk.feature.base_feature import ImgflipBaseFeature
from imgflip_sdk.features import _has_feature, _make_feature
...
class ImgflipSDK:
    ...
    def get_utility(self):
        return ImgflipUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ImgflipSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Free(self, data=None) -> "FreeEntity":
        ...
        from imgflip_sdk.entity.free_entity import FreeEntity
    ...
    def Premium(self, data=None) -> "PremiumEntity":
        ...
        from imgflip_sdk.entity.premium_entity import PremiumEntity
