# Imgflip SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ImgflipSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ImgflipSDK(...) and ImgflipSDK.test(...) become
#      ImgflipSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "imgflip_sdk"
_SDK_CLASS = "ImgflipSDK"
