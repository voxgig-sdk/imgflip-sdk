...
describe("FreeDirect", function()
  it("should direct-load-free", function()
    local setup = free_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-free", setup.live and "live" or "unit")
...
function free_direct_setup(mockres)
