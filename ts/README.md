# Imgflip TypeScript SDK



The TypeScript SDK for the Imgflip API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Free()` — each with a small set of operations (`load`, `create`)
...
| `Free(data?)` | `FreeEntity` | Create a Free entity instance. |
| `Premium(data?)` | `PremiumEntity` | Create a Premium entity instance. |
| `tester(testopts?, sdkopts?)` | `ImgflipSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `ImgflipSDK.test(testopts?, sdkopts?)` | `ImgflipSDK` | Create a test-mode client. |
...
| `client` | `client(): ImgflipSDK` | Return the parent SDK client. |
