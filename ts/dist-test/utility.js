...
function envOverride(m) {
    if ('TRUE' === process.env.IMGFLIP_TEST_LIVE ||
        'TRUE' === process.env.IMGFLIP_TEST_OVERRIDE) {
    ...
    m.IMGFLIP_TEST_EXPLAIN = process.env.IMGFLIP_TEST_EXPLAIN || m.IMGFLIP_TEST_EXPLAIN;
    return m;
}
