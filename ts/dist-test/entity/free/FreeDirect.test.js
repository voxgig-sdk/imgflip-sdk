...
(0, node_test_1.describe)('FreeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-free', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-free', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.IMGFLIP_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ImgflipSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.IMGFLIP_APIKEY,
            secret: env.IMGFLIP_SECRET,
        }));
        let idmap = env['IMGFLIP_TEST_FREE_ENTID'];
    ...
    const client = new __1.ImgflipSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=FreeDirect.test.js.map