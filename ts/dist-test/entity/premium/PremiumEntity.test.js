...
(0, node_test_1.describe)('PremiumEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'premium.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != premium_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/premium/PremiumTestData.json');
    ...
    let idmap = transform(['premium01', 'premium02', 'premium03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['IMGFLIP_TEST_PREMIUM_ENTID'];
...
//# sourceMappingURL=PremiumEntity.test.js.map