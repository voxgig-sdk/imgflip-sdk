...
class PremiumEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PremiumEntity($this->_client, $opts);
    }

    /**
     * @param Premium|array $args Premium data (assoc-array) to store.
     */
    ...
    /**
     * @return Premium|array The current Premium data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Premium fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Premium fields).
     */
     ...
     *
     * @param PremiumCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PremiumCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Premium|array The created Premium as an assoc-array at the
