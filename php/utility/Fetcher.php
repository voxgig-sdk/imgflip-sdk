...
// Imgflip SDK utility: fetcher

class ImgflipFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ImgflipSDK/1.0)';
    ...
    public static function call(ImgflipContext $ctx, string $fullurl, array $fetchdef): array
    {
