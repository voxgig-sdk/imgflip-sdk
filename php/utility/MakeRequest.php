...
// Imgflip SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ImgflipMakeRequest
{
    public static function call(ImgflipContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ImgflipResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ImgflipResponse($fetched);
        } else {
