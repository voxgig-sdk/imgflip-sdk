...
// Imgflip SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ImgflipTestFeature extends ImgflipBaseFeature
{
    ...
    public function init(ImgflipContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ImgflipContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ImgflipContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ImgflipContext $ctx, $op, $args): array
    {
