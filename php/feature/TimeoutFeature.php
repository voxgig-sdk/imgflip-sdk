...
class ImgflipTimeoutFeature extends ImgflipBaseFeature
{
    ...
    private function _with_timeout(ImgflipContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ImgflipContext $_ctx, float $ms): void
    {
        $client = $this->client;
