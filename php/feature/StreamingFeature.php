...
class ImgflipStreamingFeature extends ImgflipBaseFeature
{
    ...
    private function _iterate(ImgflipResult $result): \Generator
    {
    ...
    private function _streamable(ImgflipContext $ctx): bool
    {
