...
class ImgflipProxyFeature extends ImgflipBaseFeature
{
    ...
    public function init(ImgflipContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ImgflipContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
