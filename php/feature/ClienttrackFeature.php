...
// Imgflip SDK clienttrack feature
...
class ImgflipClienttrackFeature extends ImgflipBaseFeature
{
    ...
    public function PostConstruct(ImgflipContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Imgflip-SDK';
