...
class ImgflipRatelimitFeature extends ImgflipBaseFeature
{
    ...
    private function _acquire(ImgflipContext $ctx): void
    {
    ...
    private function _track(ImgflipContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
