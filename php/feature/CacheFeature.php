...
class ImgflipCacheFeature extends ImgflipBaseFeature
{
    ...
    private function _through(ImgflipContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
