...
class ImgflipTestRunner
{
    ...
    {
        $live = self::getenv('IMGFLIP_TEST_LIVE');
        $override = self::getenv('IMGFLIP_TEST_OVERRIDE');
        ...
        $explain = self::getenv('IMGFLIP_TEST_EXPLAIN');
...
class_alias('ImgflipTestRunner', 'Runner');
class_alias('ImgflipHelpers', 'Helpers');
