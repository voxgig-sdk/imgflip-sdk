...
class FreeDirectTest extends TestCase
{
    public function test_direct_load_free(): void
    {
        $setup = free_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-free", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
