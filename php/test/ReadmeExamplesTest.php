...
// Imgflip SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ImgflipSDK::test)
...
{
    private const SDK_CLASS = 'ImgflipSDK';
    ...
    private const SDK_BASE = 'imgflip_sdk';
