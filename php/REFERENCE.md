# Imgflip PHP SDK Reference

Complete API reference for the Imgflip PHP SDK.
...
#### `ImgflipSDK::test($testopts = null, $sdkopts = null)`
...
Create a new `FreeEntity` instance. Pass `null` for no initial data.
