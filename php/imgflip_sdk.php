...
class ImgflipSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = ImgflipHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = ImgflipHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!ImgflipFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, ImgflipFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return ImgflipUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = ImgflipHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = ImgflipHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = ImgflipHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new ImgflipError($op . "_allow",
                "ImgflipSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = ImgflipHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new ImgflipError("graphql_error",
                "ImgflipSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Free($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_free === null) {
                $this->_free = new FreeEntity($this, null);
            }
            return $this->_free;
        }
        return new FreeEntity($this, $data);
    }
    ...
    public function Premium($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_premium === null) {
                $this->_premium = new PremiumEntity($this, null);
            }
            return $this->_premium;
        }
        return new PremiumEntity($this, $data);
    }
