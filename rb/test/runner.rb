...
module ImgflipTestRunner
  ...
  def self.env_override(m)
    live = getenv("IMGFLIP_TEST_LIVE")
    override = getenv("IMGFLIP_TEST_OVERRIDE")
    ...
    explain = getenv("IMGFLIP_TEST_EXPLAIN")
    m["IMGFLIP_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ImgflipTestRunner
Helpers = ImgflipHelpers
Vs = VoxgigStruct
