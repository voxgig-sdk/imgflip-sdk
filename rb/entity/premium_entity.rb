...
class PremiumEntity
  ...
  def make
    opts = @_entopts.dup
    PremiumEntity.new(@_client, opts)
  end
  ...
  # @return [Premium, Hash] the current Premium data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Premium fields)
  def match_get
  ...
  #
  # @param reqdata [PremiumCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Premium, Hash] the created Premium; raises ImgflipError on failure
