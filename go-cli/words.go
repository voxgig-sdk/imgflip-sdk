...
func registerSDKWords(r *eng.Registry, client *sdk.ImgflipSDK) {
...
func runOp(client *sdk.ImgflipSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
