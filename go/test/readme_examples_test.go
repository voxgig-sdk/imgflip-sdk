...
const testSeed = `map[string]any{"entity": map[string]any{"free": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "premium": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
