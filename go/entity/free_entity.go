...
func NewFreeEntity(client *core.ImgflipSDK, entopts map[string]any) *FreeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FreeEntity) GetName() string { return e.name }
...
func (e *FreeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FreeEntity) Deleted() bool {
	return e.deleted
}


func (e *FreeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFreeEntity(e.client, opts)
}

func (e *FreeEntity) Data(args ...any) any {
...
func (e *FreeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *FreeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FreeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *FreeEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *FreeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FreeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FreeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
