...
func NewPremiumEntity(client *core.ImgflipSDK, entopts map[string]any) *PremiumEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PremiumEntity) GetName() string { return e.name }
...
func (e *PremiumEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PremiumEntity) Deleted() bool {
	return e.deleted
}


func (e *PremiumEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPremiumEntity(e.client, opts)
}

func (e *PremiumEntity) Data(args ...any) any {
...
func (e *PremiumEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Premium; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PremiumEntity) DataTyped(data ...Premium) Premium {
	if len(data) > 0 {
		return typedFrom[Premium](e.Data(asMap(data[0])))
	}
	return typedFrom[Premium](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Premium (all fields
// optional at the wire level).
func (e *PremiumEntity) MatchTyped(match ...Premium) Premium {
	if len(match) > 0 {
		return typedFrom[Premium](e.Match(asMap(match[0])))
	}
	return typedFrom[Premium](e.Match())
}
...
func (e *PremiumEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PremiumEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PremiumEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PremiumEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PremiumCreateData and returns an Premium. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PremiumEntity) CreateTyped(reqdata PremiumCreateData, ctrl map[string]any) (Premium, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Premium{}, err
	}
	return typedFrom[Premium](res), nil
}



func (e *PremiumEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PremiumEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PremiumEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
