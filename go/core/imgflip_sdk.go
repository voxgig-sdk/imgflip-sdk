...
func (sdk *ImgflipSDK) OptionsMap() map[string]any {
...
func (sdk *ImgflipSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ImgflipSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ImgflipSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ImgflipSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ImgflipSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ImgflipSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ImgflipSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ImgflipSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ImgflipSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ImgflipSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
