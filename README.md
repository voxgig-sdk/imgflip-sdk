...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/imgflip` | `npm install @voxgig-sdk/imgflip` |
| Python | `voxgig-sdk-imgflip` | `pip install voxgig-sdk-imgflip` |
| PHP | `voxgig-sdk/imgflip` | `composer require voxgig-sdk/imgflip` |
| Golang | `github.com/voxgig-sdk/imgflip-sdk/go` | `go get github.com/voxgig-sdk/imgflip-sdk/go` |
| Ruby | `voxgig-sdk-imgflip` | `gem install voxgig-sdk-imgflip` |
| Lua | `voxgig-sdk-imgflip` | `luarocks install voxgig-sdk-imgflip` |
