...
|---|---|---|
| `ts/` | @voxgig-sdk/imgflip-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/imgflip-sdk \
      --repository voxgig-sdk/imgflip-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/imgflip-sdk` shows it, and
`npm trust revoke @voxgig-sdk/imgflip-sdk --id=<id>` removes it.
