...
from projectname_sdk.core.control import ImgflipControl
...
class ImgflipContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, ImgflipResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ImgflipError(code, msg, self)
