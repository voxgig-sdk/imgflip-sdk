...
from projectname_sdk import ImgflipSDK
from projectname_sdk.core.spec import ImgflipSpec
from projectname_sdk.core.result import ImgflipResult
from projectname_sdk.core.response import ImgflipResponse
from projectname_sdk.core.operation import ImgflipOperation
from projectname_sdk.core.error import ImgflipError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import ImgflipBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = ImgflipSDK.test(None, None)
        ...
        class TestInitFeature(ImgflipBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ImgflipBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ImgflipSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ImgflipSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ImgflipSDK.test(None, setup_opts)
