...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = ImgflipOmni.make_runner(TEST_JSON_FILE, ImgflipSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : ImgflipOmni.errify(err)
    end
