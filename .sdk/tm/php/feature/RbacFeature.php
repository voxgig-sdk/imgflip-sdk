...
class ImgflipRbacFeature extends ImgflipBaseFeature
{
    ...
    private function _required(ImgflipContext $ctx): ?string
    {
    ...
    private function _reject(ImgflipContext $ctx, string $required): void
    {
    ...
    private function _track(ImgflipContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
