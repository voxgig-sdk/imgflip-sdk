...
class ImgflipNetsimFeature extends ImgflipBaseFeature
{
    ...
    private function _simulate(ImgflipContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ImgflipContext $ctx, array $applied): void
    {
        $client = $this->client;
