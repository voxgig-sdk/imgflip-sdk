...
class ImgflipGraphql
{
    ...
    // equivalent.
    public static function body(ImgflipContext $ctx): mixed
    {
    ...
    public static function errors(ImgflipContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
