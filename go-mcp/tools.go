...
type Args struct {
	Entity string         `json:"entity" jsonschema:"free | premium"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ImgflipSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "imgflip_list",
		Description: "List records from Imgflip. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "imgflip_load",
		Description: "Load a single record from Imgflip. " +
...
func runOp(client *sdk.ImgflipSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ImgflipSDK, name string) (sdk.ImgflipEntity, error) {
	switch strings.ToLower(name) {
	case "free":
		return client.Free(nil), nil
	case "premium":
		return client.Premium(nil), nil
